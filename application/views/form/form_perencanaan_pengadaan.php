                    ...
                    <div class="card border">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'kkp' ? 'active' : '' ?> disabled" data-toggle="tab" href="#kkp" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Kkp</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'rks' ? 'active' : '' ?> disabled" data-toggle="tab" href="#rks" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Rks</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'referensi_harga' ? 'active' : '' ?> disabled" data-toggle="tab" href="#referensi_harga" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Referensi Harga</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'hpe' ? 'active' : '' ?> disabled" data-toggle="tab" href="#hpe" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Hpe</span></a> </li>
                            </ul>
