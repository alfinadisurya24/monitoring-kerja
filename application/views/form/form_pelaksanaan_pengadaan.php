                    ...
                    <div class="card border">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'hps' ? 'active' : '' ?> disabled" data-toggle="tab" href="#hps" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Hps</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'ba_aanwijzing' ? 'active' : '' ?> disabled" data-toggle="tab" href="#ba_aanwijzing" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Berita Acara Aanwijzing</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'cda' ? 'active' : '' ?> disabled" data-toggle="tab" href="#cda" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">CDA</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'perjanjian' ? 'active' : '' ?> disabled" data-toggle="tab" href="#perjanjian" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Perjanjian</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'jaminan_pelaksanaan_pemeliharaan' ? 'active' : '' ?> disabled" data-toggle="tab" href="#jaminan_pelaksanaan_pemeliharaan" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Jaminan Pelaksanaan Pemeliharaan</span></a> </li>
                            </ul>
