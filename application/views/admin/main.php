...
<head>
    ...
    <link href="<?= base_url( 'assets/admin/css/lib/chartist/chartist.min.css')?>" rel="stylesheet">
	<link href="<?= base_url( 'assets/admin/css/lib/owl.carousel.min.css')?>" rel="stylesheet" />
    <link href="<?= base_url( 'assets/admin/css/lib/owl.theme.default.min.css')?>" rel="stylesheet" />
    <!-- Bootstrap Core CSS -->
    ...
    <script src="<?= base_url( 'assets/admin/js/lib/owl-carousel/owl.carousel.min.js')?>"></script>
    <script src="<?= base_url( 'assets/admin/js/lib/owl-carousel/owl.carousel-init.js')?>"></script>
