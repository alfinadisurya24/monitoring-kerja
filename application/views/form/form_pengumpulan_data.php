                    ...
                    <div class="card border">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'rab' ? 'active' : '' ?> disabled" data-toggle="tab" href="#rab" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Rab</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'tor' ? 'active' : '' ?> disabled" data-toggle="tab" href="#tor" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Tor</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'tug' ? 'active' : '' ?> disabled" data-toggle="tab" href="#tug" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Tug</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'justifikasi' ? 'active' : '' ?> disabled" data-toggle="tab" href="#justifikasi" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Justifikasi</span></a> </li>
                                <li class="nav-item"> <a class="nav-link <?= $_GET['child'] == 'ba' ? 'active' : '' ?> disabled" data-toggle="tab" href="#ba" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Berita Acara</span></a> </li>
                            </ul>
