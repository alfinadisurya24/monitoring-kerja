                            ...
                            <?php if($action == 'detail') { ?>
                                ...
                                <?php if ($_SESSION['role'] == "admin") {?>
                                    <div class="row">
                                        ...
                                        <div class="col-2 col-sm-2 col-md-2 col-lg-2">
                                            <a href="<?=base_url()?>main/tahapan_v/mro/<?=$field->id_pekerjaan?>?child=profile_risiko" class="btn btn-primary text-white w-100 font-weight-bold">Tahapan 2 <br> MRO (Manajemen Risiko) <br> Pengadaan</a>
                                        </div>
                                        <div class="col-2 col-sm-2 col-md-2 col-lg-2">
                                            <a href="<?=base_url()?>main/tahapan_v/perencanaan_pengadaan/<?=$field->id_pekerjaan?>?child=kkp" class="btn btn-primary text-white w-100 font-weight-bold">Tahapan 3 <br> Perencanaan <br> Pengadaan</a>
                                        </div>
                                        <div class="col-2 col-sm-2 col-md-2 col-lg-2">
                                            <a href="<?=base_url()?>main/tahapan_v/pelaksanaan_pengadaan/<?=$field->id_pekerjaan?>?child=hps" class="btn btn-primary text-white w-100 font-weight-bold">Tahapan 4 <br> Pelaksanaan <br> Pengadaan</a>
                                        </div>
                                        <div class="col-2 col-sm-2 col-md-2 col-lg-2">
