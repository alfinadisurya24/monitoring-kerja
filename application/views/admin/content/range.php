        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Range Tanggal Pendaftaran</li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody id="show-data"> 
                            <?php
                                ...
                                <tr>
                                    <td><?= $i++ ?></td>
                                    <td class="text-dark"><?= tanggal_indo($value->tanggal_awal) ?></td>
                                    <td class="text-dark"><?= tanggal_indo($value->tanggal_akhir) ?></td>
                                    <td>
                                        <a href="<?= base_url()?>main/proses/<?=$page?>/update/<?=$value->id?>" class="btn btn-info btn-sm editData m-1">Update</a>
                                        <!-- <button class="btn btn-danger btn-sm m-1 deleteData" data-id="<?#= $value->id ?>">Delete</button> -->
                                    </td>
                                </tr>
                            <?php } ?>                             
                        </tbody>
